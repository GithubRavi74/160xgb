...
def create_pdf(data):
    ...
    pdf.cell(50) 
    pdf.cell(140, 5, f"Analysis for Current Batch", ln=True, align="L")
    pdf.cell(50) 
    ...
    disclaimer = "Disclaimer: This report is generated by an AI model. Predictions are estimates based on input data and biological variables. Idealogic is not liable for financial discrepancies resulting from unexpected environmental or health factors."
    pdf.multi_cell(190, 4, disclaimer, align="C")
...
st.markdown("""
    ...
    <h2 style='color: green;'>Farm Data Trained AI Weight & Profit Analytics</h2>
...
if model is None:
    ...
    if st.button("🚀 Run AI Business Analysis", use_container_width=True):
        ...
        st.session_state['pdf_bytes'] = create_pdf(st.session_state['report_data'])
